globals [ doves-extinct? hawks-extinct? retaliators-extinct? generation ]
...
"" ""
PENS
"hawks" 1.0 0 -2674135 true "" "plot ifelse-value (any? hawks with [fighting = true]) \n[ mean [payoff] of hawks with [ fighting = true] ]\n[ 0 ]"
"doves" 1.0 0 -13345367 true "" "plot ifelse-value (any? doves with [fighting = true]) \n[ mean [payoff] of doves with [ fighting = true] ]\n[ 0 ]"
"retaliators" 1.0 0 -10899396 true "" "plot ifelse-value (any? retaliators with [fighting = true]) \n[ mean [payoff] of retaliators with [ fighting = true] ]\n[ 0 ]"
...
283
Dove Payoff
ifelse-value (any? doves with [ fighting = true ]) \n[ mean [payoff] of doves with [ fighting = true ]]\n[ \"\" ]
2
1
11
...
283
Hawk Payoff
ifelse-value (any? hawks with [ fighting = true ]) \n[ mean [payoff] of hawks with [ fighting = true ]]\n[ \"\" ]
2
1
11
...
283
Retaliators Payoff
ifelse-value (any? retaliators with [ fighting = true ]) \n[ mean [payoff] of retaliators with [ fighting = true ]]\n[ \"\" ]
3
1
11
